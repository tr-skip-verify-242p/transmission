...
Prefs::PrefItem Prefs::myItems[] =
{
    ...
    { QUEUE_ENABLED_DOWNLOAD, TR_PREFS_KEY_QUEUE_ENABLED_DOWNLOAD, QVariant::Bool },
    { QUEUE_ENABLED_SEED, TR_PREFS_KEY_QUEUE_ENABLED_SEED, QVariant::Bool },
    { QUEUE_MAX_DOWNLOAD_ACTIVE, TR_PREFS_KEY_QUEUE_MAX_DOWNLOAD_ACTIVE, QVariant::Int },
    { QUEUE_MAX_SEED_ACTIVE, TR_PREFS_KEY_QUEUE_MAX_SEED_ACTIVE, QVariant::Int },
    { QUEUE_NEW_TORRENTS_TOP, TR_PREFS_KEY_QUEUE_NEW_TORRENTS_TOP, QVariant::Bool },
    { QUEUE_SKIP_SLOW_TORRENTS, TR_PREFS_KEY_QUEUE_SKIP_SLOW_TORRENTS, QVariant::Bool },
    { QUEUE_SLOW_COUNT, TR_PREFS_KEY_QUEUE_SLOW_COUNT, QVariant::Int },
    { QUEUE_SLOW_CUTOFF, TR_PREFS_KEY_QUEUE_SLOW_CUTOFF_KBps, QVariant::Int },
    { QUEUE_SPEED_LIMIT, TR_PREFS_KEY_QUEUE_SPEED_LIMIT, QVariant::Bool },
