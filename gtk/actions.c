...
static GtkActionEntry entries[] =
{
    ...
    { "verify-torrent", NULL, N_( "_Verify Local Data" ), "<control><alt>V", NULL, G_CALLBACK( action_cb ) },
    ...
    { "relocate-torrent", NULL, N_("Set _Location..." ), "<control>L", NULL, G_CALLBACK( action_cb ) },
    { "rename-torrent-top", NULL, N_( "_Rename Toplevel Directory" ), NULL, NULL, G_CALLBACK( action_cb ) },
    ...
    { "edit-preferences", GTK_STOCK_PREFERENCES, NULL, "<control><alt>P", NULL, G_CALLBACK( action_cb ) },
